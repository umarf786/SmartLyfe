...
<body class='bg-slate-600'>
    <div class="grid grid-cols-12 grid-rows-3 ">
        ...
        <div class=" col-span-10 row-span-6">
            <p class='text-4xl text-center mt-12 text-white'>Good to see you, <?php echo $_SESSION['name']; ?>. &nbsp
                Here are your statistics...</p>
                ...
                <div class="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
                    ...
                    <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                        <div
                            ...
                            <h1
                                class="text-3xl flex justify-center items-center sm:text-4xl xl:text-5xl font-bold text-gray-700 group-hover:text-gray-50">
                                37</h1>
                            <div class="flex flex-row justify-center items-center  group-hover:text-gray-200">
