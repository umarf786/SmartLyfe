        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Remove Users</h1>
                    <p class="lead fw-normal text-white-50 mb-0"><?php echo "Currently logged in: " . $_SESSION['user'] ?></p>
                </div>
            </div>
        </header>
        <!-- Section-->
                            ...
                            <div class="card h-100">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <h5 class="fw-bolder">Email: '.$email.'</h5>
                                        <h5 class="fw-bolder">Name: '.$name.'</h5>
                                        <h5 class="fw-bolder">Role: '.$role.'</h5>
                                    </div>
                                </div>  
                                <form action="deleteUserFunction.php" method="POST">
                                    ...
                                    <input type="hidden" name="admin" value="'.$email.'">
